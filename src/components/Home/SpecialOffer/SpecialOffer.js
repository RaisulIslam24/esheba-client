                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xs-12 col-sm-6 mobile-flex">
                                ...
                                <h1 class="offer-title mb-5 mb-sm-6">Summer Time: Grab this deal right now, tomorrow might be gone!</h1>
                                ...
                                <div class="mt-3">
                                    <div class="money-back-container">
                                        <div>
                                            ...
                                            </svg></span><span class="vertical-middle money-back c-bw-12">Covered by the 30-day money-back guarantee policy.
                                                <Link to="" alt="" class='more-info-link'>More info</Link></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
