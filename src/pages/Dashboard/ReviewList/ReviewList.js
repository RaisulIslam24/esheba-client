                            ...
                            <TableBody>
                                {reviews.map((review, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell align="left"> {truncate(review.description, 20)} </TableCell>
                                        <TableCell align="left">{review.date}</TableCell>
                                        <TableCell align="left"><DeleteOutlineIcon onClick={() => deleteReview(review._id)} className="deleteReviewIcon" /></TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
